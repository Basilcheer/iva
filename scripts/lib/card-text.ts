...
// зависимостей и лежит в scripts/lib намеренно: его тянет и бандл агента (frontmatter,
// card-store), и ночной doctor, и CLI-дерево, в котором каталога agent/ нет вовсе.
