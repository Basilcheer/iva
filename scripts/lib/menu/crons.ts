...
// data/rollup-status.json (agent/lib/schedule-runner.ts). Пагинация systemd-списка по 8;
...
// runScheduledJob (see agent/lib/schedule-runner.ts), not the bare period.
const EVE_SCHEDULES = [
