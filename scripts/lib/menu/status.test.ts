...
// Пробелов вокруг значения здесь нет намеренно: парсер .env их срезает (LINE_RE в
// scripts/lib/env-file.ts), до экрана они не доезжают — их ловит резолвер рантайма,
// который читает process.env напрямую.
