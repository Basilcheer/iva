...
- 🗄️ **Ваш vault, ваш репозиторий** — память живёт в отдельном приватном git-репозитории, который принадлежит вам; ночной brain коммитит и пушит его ([memory.md](memory.md)).
