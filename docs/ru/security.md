...
- 🚫 **Детекция инъекций** — маркеры ролей (`system:`, `assistant:`, `admin:`, `Система:`, `Tizim:` …) плюс 24 override-паттерна на трёх языках: английский («ignore previous instructions», «DAN mode», «reveal your system prompt» …), русский («игнорируй все предыдущие инструкции», «режим разработчика», «системный промпт» …) и узбекский («oldingi ko'rsatmalarni unut», «tizim prompti» …). Агент читает русский и узбекский веб: англоязычный детектор на такой странице не сработал бы ни разу. Порог блокировки, прямо из кода: 2+ маркера ролей вместе с 1+ override — или 3+ override сами по себе. Паттерны идут и по сырому тексту, и по нормализованной копии: нормализация снимает маскировку с латиницы, но ломает кириллическое слово.
