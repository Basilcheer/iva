...
The log lives in `data/` next to `tasks.json`, gitignored and outside the vault — otherwise the nightly brain would commit an ever-growing log into your memory repo.
