...
Три сообщения, чтобы понять, что у вас теперь есть:

1. Наговорите голосовое про свой день - что угодно, вслух. Оно ляжет в `daily/` слово в слово, а Ива ответит текстом.
2. `Напомни завтра в 9 позвонить в банк` - напоминание придёт, календарь не нужен.
3. Завтра: `что я тебе вчера рассказывал?` - ответ придёт из памяти, а не из окна чата.
