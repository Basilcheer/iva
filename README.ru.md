...
- 🛡️ Миграция добавила более строгие линтинг, проверку типов и coverage-гейты, а последующие проверки сохранили поведение на редких Telegram-сценариях и точность учёта токенов.
- 🗺️ Оглавление памяти теперь пересобирается по реально существующим доменам, а общие фикстуры не дают TypeScript- и Python-парсерам расходиться.
