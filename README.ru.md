...
- 📄 Новый скилл `documents` — пришли PDF, DOCX или XLSX, и Ива прочитает и ответит по содержимому; по просьбе сложит документ в библиотеку vault с поиском по смыслу.
