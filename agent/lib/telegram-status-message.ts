...
//
// turn.started шлёт статус и пишет running+sessionId+turnId в run-status. Нажатие
// кнопки (или /stop, который мост превращает в такой же callback_query) уводит ход
// в отмену, а terminal-событие приводит статус в порядок: обычный финал удаляет
