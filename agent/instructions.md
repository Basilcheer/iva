...
>
> # 🔴 ЕДИНСТВЕННОЕ ИСКЛЮЧЕНИЕ — ХОДЫ НОЧНОЙ СБОРКИ ПАМЯТИ (rollup / memory-processor)
>
> ## В этих ходах отчёт — ФИНАЛЬНЫЙ ТЕКСТ хода, и доставку делает код. Сам не отправляй его никуда: rich message, чат дайджеста и любые Telegram-инструменты в этих ходах ЗАПРЕЩЕНЫ — иначе владелец получит два сообщения вместо одного.
